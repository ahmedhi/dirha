        ...
        <!-- Type D'Evolution -->
            <div class="input-group form-group">
                ...
                <select name="TypeEvolution" class="form-control">
                    <option value="0" >Perte de poids</option>
                    <option value="1" selected="selected">Stabilisation du poids</option>
        ...
        <!-- Type D'Activité -->
            <div class="input-group form-group">
                ...
                <select name="TypeActivite" class="form-control">
                    ...
                    <option value="2" >Entrainement plus de 6 fois par semaine</option>
                </select>
            </div>
