            ...
            <div class="card-body">
                ...
                <!-- Energie Kcal -->
                    <div class="col input-group form-group">
                        ...
                        <input type="number" min="0" class="form-control" placeholder="Energie Kcal" name="energie Kcal" value="{{ old('energie_Kcal') }}"> <div class="ref"> (kcal) </div>
                ...
                <!-- Proteines-->
                    <div class="col input-group form-group">
                        ...
                        <input type="number" min="0" class="form-control" placeholder="Proteines" name="proteines" value="{{ old('proteines') }}"> <div class="ref"> (g) </div>
                ...
                <!-- Glucides-->
                    <div class="col input-group form-group">
                        ...
                        <input type="number" min="0" class="form-control" placeholder="Glucides" name="glucides" value="{{ old('glucides') }}"> <div class="ref"> (g) </div>
                ...
                <!-- Lipides -->
                    <div class="col input-group form-group">
                        ...
                        <input type="number" min="0" class="form-control" placeholder="Lipides" name="lipides" value="{{ old('lipides') }}"> <div class="ref"> (g) </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col input-group form-group">
                            ...
                            <input type="number" min="0" class="form-control" placeholder="Fibre" name="fibres" value="{{ old('fibres') }}"> <div class="ref"> (g) </div>
                ...
                <!-- Boutton de confirmation -->
                    <div style="text-align: center;">
                        <div class="form-group">
                            <button type="submit" class="VoirPlus" >Ajouter</button>
                        </div>
                    </div>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            @foreach( $aliments as $aliment)
                <tr>
                    <th scope="col"><img src="/img/Aliments/{{ $aliment->nom }}.png" style="height: 30px ; width: 50px"></th>
