...
@section('content')
    ...
    <div style="background: url(img/hero-bg1.png); background-repeat: no-repeat ; background-attachment: fixed ; background-size: 100% 100%;"  >
        <div class="container" style="padding-top: 150px;">
            <div class="card" style="height: 3000px ; border-top-right-radius: 40px; border-top-left-radius: 40px; background-color: whitesmoke">
                <img src="img/review-bg.jpg" style="border-top-right-radius: 40px; border-top-left-radius: 40px;">
